...
виконав Чорний Ігор ІО-44 

в цій лабораторній майже так само як і в третій але тут йдуть запити більш складніші
...
---
(в цей раз зробив таблиці так як той сайт одразу пропонує їх передати в мд файл)
